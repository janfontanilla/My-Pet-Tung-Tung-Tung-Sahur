--!strict
-- FacesPanel.client.lua (reference 04)
...
local _gui, body = PanelBase.create("faces", "Faces")
...
for i, face in ipairs(Catalog.Faces) do
	...
	btn.Activated:Connect(function()
		Remotes.event("SetFace"):FireServer(face.id)
	end)
end
